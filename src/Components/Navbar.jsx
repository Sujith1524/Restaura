...
import { FaTimes, FaBars } from "react-icons/fa";  // ✅ import both icons

const Navbar = () => {
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false); // ✅ fixed setter name
  ...
  const handleScroll = (event, targetId) => {
    ...
    const targetElement = document.getElementById(targetId); // ✅ fixed variable
    if (targetElement) {
